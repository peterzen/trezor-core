...
DecredAddress = const(116)
DecredEntropyAck = const(117)
DecredGetAddress = const(115)
DecredLoadDevice = const(114)
DecredSignMessage = const(118)
DecredSignTx = const(120)
DecredTxAck = const(121)
DecredTxRequest = const(122)
DecredVerifyMessage = const(119)
